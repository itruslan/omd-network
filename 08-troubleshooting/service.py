#!/usr/bin/env python3
"""Служба на сервере учебного стенда главы 8.

Отвечает коротко и предсказуемо: задача практики — не разобрать приложение,
а различить участок, на котором обращение к нему прерывается.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Lab service for chapter 8.")
