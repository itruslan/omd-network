...
def main() -> None:
    ...
    for value in args.targets:
        # Диапазон и одиночный адрес требуют разных отношений: у адреса их
        # два — входит или нет, — а у сети три: она может быть вложена,
        # может сама содержать нашу, а может не пересекаться с ней вовсе.
        if "/" in value:
