#!/usr/bin/env python3
"""Служба на сервере учебного стенда главы 9.

В ответе называет адрес, с которого пришло соединение: именно он меняется
при трансляции адреса источника, и увидеть это надо со стороны сервера.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Lab service for chapter 9.")
